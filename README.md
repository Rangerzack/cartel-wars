...
|-----------|-------------------------------------------------|----------------------|-----------|
| `main`    | `https://<user>.github.io/cartel-wars/`         | —                    | the live game: everything, full casino and forum |
| `staging` | `https://<user>.github.io/cartel-wars/staging/` | `VITE_STAGE=staging` | the same build, for trying new features before they go live |
