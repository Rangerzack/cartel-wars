...
case "${1:-reset}" in
  ...
  test)  reset; psql -v ON_ERROR_STOP=1 -q -f "$ROOT/scripts/smoke-test.sql"; psql -v ON_ERROR_STOP=1 -q -f "$ROOT/scripts/casino-test.sql"; psql -v ON_ERROR_STOP=1 -q -f "$ROOT/scripts/forum-test.sql"; psql -v ON_ERROR_STOP=1 -q -f "$ROOT/scripts/features-test.sql" ;;
